...
var AuthorizationController = require('./security/authorizations/authorization.controller');
...
// Instructions:
// Request order:
// /api/datageneration/authorizations
...
//<editor-fold desc="Authorization Generation">
function populateRequestForAuthorization(req, auth) {
    req.body.name = auth;
}

exports.createAuthorization = function (req, res) {
    var authEnum = ['*', 'get', 'put', 'post', 'delete'];
    for (var i = 0; i < authEnum.length; i++) {
        populateRequestForAuthorization(req, authEnum[i]);
        AuthorizationController.postAuthorization(req, res);
    }
};

exports.cleanAuthorizations = function (req, res) {
    populateRequestForUser(req);
    AuthorizationController.deleteAuthorizationByName(req, res);
};
//</editor-fold>

//<editor-fold desc="User Generation">
...
//<editor-fold desc="Group generation">
...
//<editor-fold desc="Location generation">
